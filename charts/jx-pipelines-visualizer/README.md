...
| gatewayApi.basicAuth.authData | string | `""` |  |
| gatewayApi.basicAuth.enabled | bool | `false` |  |
| gatewayApi.basicAuth.existingSecret | string | `""` |  |
| gatewayApi.basicAuth.kind | string | `"envoy"` |  |
| gatewayApi.enabled | bool | `false` |  |
| gatewayApi.hosts | list | `[]` |  |
| gatewayApi.labels | object | `{}` |  |
| gatewayApi.parentRef.name | string | `"envoy-gateway"` |  |
| gatewayApi.parentRef.namespace | string | `"envoy-gateway-system"` |  |
| gatewayApi.parentRef.sectionName | string | `"https"` |  |
| gatewayApi.rules[0].matches[0].path.type | string | `"PathPrefix"` |  |
| gatewayApi.rules[0].matches[0].path.value | string | `"/"` |  |
