...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx-pipelines-visualizer/master/17'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-pipelines-visualizer:1.8.20'
