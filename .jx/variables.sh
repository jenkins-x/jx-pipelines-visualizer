...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x/jx-pipelines-visualizer/HEAD/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-pipelines-visualizer:1.7.2'
