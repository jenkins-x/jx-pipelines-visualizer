...
var (
	codecs = serializer.WithoutConversionCodecFactory{CodecFactory: scheme.Codecs}
)

const (
	FactNameUpdate          string = "susfu"
	errorDuringGETMessage   string = "error during GET"
	errorDuringPATCHMessage string = "error during PATCH"
)
